...
TRAIN_IMAGE_DIR = ROOT_DIR + IMG_DIR + "/rot_train"
TRAIN_ANNOTATION_DIR = ROOT_DIR +  ANNOTATION_DIR + "/rot_train"

VALIDATE_IMAGE_DIR = ROOT_DIR + IMG_DIR + "/validate_resize"
VALIDATE_ANNOTATION_DIR = ROOT_DIR +  ANNOTATION_DIR + "/validate_resize"

TEST_IMAGE_DIR = ROOT_DIR + IMG_DIR + "/validate_resize"
TEST_ANNOTATION_DIR = ROOT_DIR +  ANNOTATION_DIR + "/validate_resize"
